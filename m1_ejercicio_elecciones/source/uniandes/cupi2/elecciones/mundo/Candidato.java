...
public class Candidato
{
    ...
    // Atributos
    // -----------------------------------------------------------------
     private int votosInfXInternet;
     private int votosGenMasculino;
     private int votosGenFemenino;
